package com.aerion.tablefeed.service
...
import com.aerion.tablefeed.MainActivity
import com.aerion.tablefeed.R
...
class TablefeedMessagingService : FirebaseMessagingService() {
    ...
    companion object {
        private const val TAG = "TablefeedFCM"
        const val CHANNEL_ID = "tablefeed_social"
    }
}
