...
import com.aerion.tablefeed.di.AppContainer
import com.aerion.tablefeed.service.TablefeedMessagingService
...
class TablefeedApplication : Application() {
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                TablefeedMessagingService.CHANNEL_ID,
                "Tablefeed",
