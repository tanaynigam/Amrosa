package com.aerion.amrosa.service
...
import com.aerion.amrosa.MainActivity
...
class AmrosaMessagingService : FirebaseMessagingService() {
    ...
    companion object {
        private const val TAG = "AmrosaFCM"
        const val CHANNEL_ID = "amrosa_social"
    }
}
