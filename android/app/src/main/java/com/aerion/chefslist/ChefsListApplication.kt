...
import com.aerion.chefslist.di.AppContainer
import com.aerion.chefslist.service.ChefsListMessagingService
...
class ChefsListApplication : Application() {
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ChefsListMessagingService.CHANNEL_ID,
                "ChefsList",
