package com.aerion.chefsjournal.di

import android.content.Context
import androidx.room.Room
import com.aerion.chefsjournal.data.auth.AuthRepository
import com.aerion.chefsjournal.data.local.ChefsJournalDatabase
import com.aerion.chefsjournal.data.local.MIGRATION_9_10
import com.aerion.chefsjournal.data.local.MIGRATION_10_11
import com.aerion.chefsjournal.data.local.MIGRATION_11_12
import com.aerion.chefsjournal.data.local.MIGRATION_12_13
import com.aerion.chefsjournal.data.local.MIGRATION_13_14
import com.aerion.chefsjournal.data.local.MIGRATION_14_15
import com.aerion.chefsjournal.data.remote.RecipeSyncService
...
class AppContainer(context: Context) {
    ...
    private val database = Room.databaseBuilder(
        ...
        ChefsJournalDatabase::class.java,
        "chefsjournal.db"
    )
    ...
    suspend fun clearAllLocalData(context: Context) {
        withContext(Dispatchers.IO) {
            ...
            context.getSharedPreferences("chefsjournal_sync", Context.MODE_PRIVATE)
                .edit().clear().apply()
        }
    }
    ...
    val userPreferences = com.aerion.chefsjournal.data.UserPreferences(context)
}
