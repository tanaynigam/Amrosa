...
extension Notification.Name {
    ...
    static let fcmTokenRefreshed = Notification.Name("AmrosaFCMTokenRefreshed")

    /// Posted when the user taps a push notification.
    /// `userInfo` contains "type" and "shareId" strings.
    static let pushNotificationTapped = Notification.Name("AmrosaPushNotificationTapped")
}
